            ...
            <div className="bg">
                <div className="main">
                    <form name="form">
                        ...
                        <input id="input_math" className="button" type="button" value="+" onClick={this.setValueOutput}/>
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input className="button" type="button" value="7" onClick={()=>this.insert(7)}/></td>
                            <td><input className="button" type="button" value="8" onClick={()=>this.insert(8)}/></td>
                            <td><input className="button" type="button" value="9" onClick={()=>this.insert(9)}/></td>
                            <td><input className="button" type="button" value="-" onClick={()=>this.insert('-')}/></td>
                        </tr>
                        <tr>
                            <td><input className="button" type="button" value="4" onClick={()=>this.insert(4)}/></td>
                            <td><input className="button" type="button" value="5" onClick={()=>this.insert(5)}/></td>
                            <td><input className="button" type="button" value="6" onClick={()=>this.insert(6)}/></td>
                            <td><input className="button" type="button" value="+" onClick={()=>this.insert('+')}/></td>
                        </tr>
                        <tr>
                            <td><input className="button" type="button" value="1" onClick={()=>this.insert(1)}/></td>
                            <td><input className="button" type="button" value="2" onClick={()=>this.insert(2)}/></td>
                            <td><input className="button" type="button" value="3" onClick={()=>this.insert(3)}/></td>
                            <td rowSpan="5"><input style={{height : '106px'}} className="button" type="button" value="=" onClick={this.equal}/></td>
                        </tr>
                        <tr>
                            <td colSpan="2"><input style={{width: '106px'}} className="button" type="button" value="0" onClick={()=>this.insert(0)}/></td>
                            <td><input className="button" type="button" value="." onClick={()=>this.insert('.')}/></td>
                        </tr>
                        </tbody>
                    </table>
